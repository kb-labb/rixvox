...
argparser.add_argument(
    "--json_dir",
    type=str,
    default="/home/fatrek/data_network/delat/audio/riksdagen/data/riksdagen_web/whisper_output_web",
)
argparser.add_argument(
    "--audio_dir",
    type=str,
    default="/home/fatrek/data_network/delat/audio/riksdagen/data/riksdagen_web/2000_2024",
)
argparser.add_argument(
    "--parquet_dir",
    type=str,
...
def audio_chunker(df, audio_dir, sr=16000):
    ...
    for df_file in df_files:
        ...
        for start, end in get_chunks(df_file):
